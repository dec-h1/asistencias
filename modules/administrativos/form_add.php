<?php
	...
	$id_generate = strtoupper(unique_id(6).'-p');
?>
<div class="form-data">
	<div class="head">
   ...
   <div class="body">
		...
		<div class="first">
				...
				<input class="text" type="text" name="txtnombre" value="" maxlength="25" required autofocus/>
                <label class="label">Apellidos</label>
				<input class="text" type="text" name="txtapellidos" value="" maxlength="50" required/>
			...
			<div class="last">
                ...
                <input class="text" type="text" name="txttelefono" value="" maxlength="10" inputmode="email" required/>
                <label class="label">Domicilio</label>
                <input class="text" type="text" name="txtdomicilio" value="" maxlength="100" required/>
				<label class="label">Nivel de estudios</label>
				<select class="select" name="selectnivelestudios">
					<option value="Licenciatura">Seleccionar</option>
				...
				<input class="text" type="text" name="txtobservacion" value="" maxlength="200"/>
			</div>
