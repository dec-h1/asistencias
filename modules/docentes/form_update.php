   ...
   <div class="body">
        <form name="form-update-users" action="update.php" method="POST">
            <div class="first">
				...
				<input class="text" type="text" name="txtnombre" value="'.$_SESSION['docente_nombre'][0].'" autofocus maxlength="25" required/>
				<label class="label">Apellidos</label>
                <input class="text" type="text" name="txtapellidos" value="'.$_SESSION['docente_apellidos'][0].'" maxlength="50" required/>
				<label class="label">CURP</label>
                <input class="text" type="text" name="txtcurp" value="'.$_SESSION['docente_curp'][0].'" maxlength="18" onkeyup="this.value = this.value.toUpperCase()" required/>
                <label class="label">RFC</label>
                <input class="text" type="text" name="txtrfc" value="'.$_SESSION['docente_rfc'][0].'" maxlength="13" onkeyup="this.value = this.value.toUpperCase()" required/>
			</div>
			<div class="last">
				<label class="label">Telefono</label>
				<input class="text" type="text" name="txttelefono" value="'.$_SESSION['docente_telefono'][0].'" maxlength="10" required/>
                <label class="label">Domicilio</label>
                <input class="text" type="text" name="txtdomicilio" value="'.$_SESSION['docente_domicilio'][0].'" maxlength="100" required/>
				...
				<input class="text" type="text" name="txtobservacion" value="'.$_SESSION['docente_observacion'][0].'" maxlength="200"/>
			</div>
