<?php
	...
	$actualizar = "UPDATE alumnos SET nombre = '".encrypt($_POST['txtnombre'], $key)."', apellidos = '".encrypt($_POST['txtapellidos'], $key)."', curp = '".encrypt($_POST['txtcurp'], $key)."', rfc = '".encrypt($_POST['txtrfc'], $key)."', domicilio = '".encrypt($_POST['txtdomicilio'], $key)."', telefono = '".encrypt($_POST['txttelefono'], $key)."', especialidad = '".encrypt($_POST['txtespecialidad'], $key)."', documentacion = '".encrypt($_POST['selectdocumentacion'], $key)."', observacion = '".encrypt($_POST['txtobservacion'], $key)."' WHERE usuario = '".encrypt($_POST['txtuserid'], $key)."'";
