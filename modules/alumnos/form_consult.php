   ...
   <div class="body">
        <form name="form-update-users" action="#" method="POST">
            <div class="first">
				...
				<input class="text" type="text" name="txtnombre" value="'.$_SESSION['alumno_nombre'][0].'" autofocus disabled/>
				<label class="label">Apellidos</label>
				<input class="text" type="text" name="txtapellidos" value="'.$_SESSION['alumno_apellidos'][0].'" disabled/>
                <label class="label">CURP</label>
                <input class="text" type="text" name="txtcurp" value="'.$_SESSION['alumno_curp'][0].'" disabled/>
                <label class="label">RFC</label>
                <input class="text" type="text" name="txtrfc" value="'.$_SESSION['alumno_rfc'][0].'" disabled/>
			</div>
			<div class="last">
				<label class="label">Telefono</label>
                <input class="text" type="text" name="txttelefono" value="'.$_SESSION['alumno_telefono'][0].'" disabled/>
                <label class="label">Domicilio</label>
                <input class="text" type="text" name="txtdomicilio" value="'.$_SESSION['alumno_domicilio'][0].'" disabled/>
				<label class="label">Especialidad</label>
                <input class="text" type="text" name="txtespecialidad" value="'.$_SESSION['alumno_especialidad'][0].'" disabled/>
				...
				<input class="text" type="text" name="txtobservacion" value="'.$_SESSION['alumno_observacion'][0].'" disabled/>
			</div>
